...
alb_id = congig['OTHER']['album_id']
use_id = congig['OTHER']['user_id']
...
class VK:
    ...
    def get_photos(self, user_id, maxcount=5):
    ...
    def upload_file(self, token2, folder_name2):
        i = 2
        for nam in tqdm(self.all_list[::3]):
            ...
            params = {'path': f'/{folder_name2}/' + filename, 'url': name_url}
...
vk_connector.get_photos(use_id)
vk_connector.create_folder(yd_tk, use_id)
vk_connector.upload_file(yd_tk, use_id)
